        ...
        void DestroyBlockOptimized(Blocks block, Vector3 blockPosition, Color blockColour)
        {
            ...
            switch (block)
            {
                ...
                case Blocks.Bookshelf:
                    ...
                    break;
                case Blocks.CoalBlock:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"Stone{Random.Range(1, 3)}"), 0.5f); break;
                case Blocks.LapisBlock:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"Stone{Random.Range(1, 3)}"), 0.5f); break;
                case Blocks.IronBlock:
                    audioSourceTemp.PlayOneShot(blockBundleAlt.LoadAsset<AudioClip>($"Metal{Random.Range(1, 4)}"), 0.5f); break;
                case Blocks.GoldBlock:
                    audioSourceTemp.PlayOneShot(blockBundleAlt.LoadAsset<AudioClip>($"Metal{Random.Range(1, 4)}"), 0.5f); break;
                case Blocks.RedstoneBlock:
                    audioSourceTemp.PlayOneShot(blockBundleAlt.LoadAsset<AudioClip>($"Metal{Random.Range(1, 4)}"), 0.5f); break;
                ...
                case Blocks.DiamondBlock:
                    audioSourceTemp.PlayOneShot(blockBundleAlt.LoadAsset<AudioClip>($"Metal{Random.Range(1, 4)}"), 0.5f); break;
                case Blocks.StainedGlass:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"GlassBreak{Random.Range(1, 4)}"), 0.5f); break;
                case Blocks.Glowstone:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"GlassBreak{Random.Range(1, 4)}"), 0.5f); break;
                case Blocks.SoulSand:
                    audioSourceTemp.PlayOneShot(blockBundleAlt.LoadAsset<AudioClip>($"Sand{Random.Range(1, 3)}"), 0.2f); break;
                ...
                case Blocks.SlimeBlock:
                    audioSourceTemp.PlayOneShot(blockBundleAlt.LoadAsset<AudioClip>($"SlimePlace{Random.Range(1, 3)}"), 0.2f); break;
                case Blocks.Pumpkin:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"Log{Random.Range(1, 3)}"), 0.5f); break;
                case Blocks.Jackolantern:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"Log{Random.Range(1, 3)}"), 0.5f); break;
                case Blocks.Melon:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"Log{Random.Range(1, 3)}"), 0.5f); break;
                case Blocks.Bedrock:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"Stone{Random.Range(1, 3)}"), 0.5f); break;
                case Blocks.HayBale:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"Grass{Random.Range(1, 3)}"), 0.5f); break;
                case Blocks.Sponge:
                    audioSourceTemp.PlayOneShot(blockBundle.LoadAsset<AudioClip>($"Grass{Random.Range(1, 3)}"), 0.5f); break;
            }
